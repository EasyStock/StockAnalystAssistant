# coding=utf-8
'''
Created on 2017-11-25 19:43:38
@author: jianpinh
...
class CIsLineDirectionUp(CStockFilterBase):
    def __init__(self):
        '''
        主要用途: 判断均线是否向上，例如5日均线的倒数3天方向是否向上的
        '''
        self._filterName = '线条向上过滤器'
    ...
    def doFilterLastDay(self, data=None, lParam=None, rParam=None):
        ...
        if len(res) == 0:
            return (False, -1)
        # 趋势向上应该是 角度大于3度，即 x > PI/60
        m = [x for x in res if x > numpy.pi/60.0]
        # 趋势向上必须的上升的占比85%以上
